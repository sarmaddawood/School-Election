    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="glass-panel rounded-3xl overflow-hidden shadow-2xl border border-white/10 relative flex flex-col max-h-[85vh]">
              ...
              <div className="px-6 pb-6 pt-0 relative flex-1 overflow-y-auto">
                ...
                <div className="space-y-6">
                  <div>
                    <h2 className="text-2xl font-display font-semibold text-white tracking-tight leading-tight">
                      {candidate.fullName}
                    </h2>
                    <p className="text-sm font-medium text-violet-400 mt-1 uppercase tracking-wider text-[11px]">
